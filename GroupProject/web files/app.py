...
def generate_image():
    return flask.render_template('generate_image.html')
...
def convert_image():
    if flask.request.method == 'GET':
        # Just render the initial form, to get input
        return(flask.render_template('convert_image.html'))
    ...
    if flask.request.method == 'POST':
        ...
        if file:
            ...
            return flask.render_template('convert_image.html', prediction=str(prediction))
